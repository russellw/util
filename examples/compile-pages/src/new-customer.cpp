...
#include "head.html"
     <style>
        #include "styles.css"
        #include "grid-styles.css"
    </style>
<title>New customer</title>
#include "menu.html"

<form method="post" style = "display:flex; flex-direction:row; align-items: flex-start; margin:20px">
    <div class="grid2">
    ...
    <div class="grid2" style="margin-left:40px">

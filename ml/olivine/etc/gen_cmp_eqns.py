...
print("static PartialOrder compare(KnuthBendixOrder order, Equation a, Equation b) {")
gen(ps)
...
print("static PartialOrder compareNP(KnuthBendixOrder order, Equation a, Equation b) {")
gen(ps)
print("throw new IllegalStateException();")
print("}")

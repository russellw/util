# generate and directly display clauses from two or three input clauses
import argparse
import datetime
import fractions
import heapq
...
def solve(cs):
    ...
    print("superposition_neg(c, d)")
    superposition_neg(c, d)
    print("superposition_neg(d, c)")
    superposition_neg(d, c)
    print("superposition_pos(c, d)")
    superposition_pos(c, d)
    print("superposition_pos(d, c)")
